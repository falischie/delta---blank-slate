...
IMPORTANT NOTE: To allow delta to be powered while working on Teensy LC, you will need to cut the Teensy LC's VUSB-VIN pads apart (5V power is already coming from the board). Please refer to the picture (Pads are on the back of the Teensy).
